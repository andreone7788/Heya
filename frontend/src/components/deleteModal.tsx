...
import { TypeDeleteUser } from "../types/user.types";
import { Button, Modal} from "@mui/material";
import { DeleteUserApi } from "../api/admin/management.api";
import { useTranslation } from "react-i18next";

type DeleteProp = {
    user : TypeDeleteUser | null
    onclose: () => void
    onopen:boolean
    ondelete?: () => void
}
export const DeleteUserModal = ({ user, onclose, onopen, ondelete}: DeleteProp) => {
